...
<head>
    ...
    <title>Login || Inventaris Sarana dan Prasarana SMK</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo menu-text fw-bolder ms-2 text-center text-capitalize" style="font-size: 25px;">Inventaris</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Inventaris Sarana dan Prasarana SMK! 👋</h4>

...
<div class="col-lg-12">
  <div class="card custom-card"> <!-- Tambahkan kelas "custom-card" di sini -->
    <div class="card-body">
      <a href="<?= base_url('/home/tambah_peminjaman/')?>"><button class="btn btn-success"><i class="fa fa-plus"></i>Tambah</button></a>
    </a>
    <br>
        ...
        <tbody>
          ...
          foreach ($jofinson as $jo){
            ...
            <tr>
              ...
              <td class="text-capitalize text-center"><?php echo $jo->jumlah_pinjam?></td>
              <td class="text-capitalize text-center"><?php echo $jo->tanggal_peminjaman?></td>
              <td class="text-capitalize text-center"><?php echo $jo->tanggal_pengembalian?></td>
              <td class="text-center">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <!-- <a class="dropdown-item" href="<?= base_url('/home/edit_peminjaman/'.$jo->id_peminjaman)?>"><i class="bx bx-edit-alt me-1"></i> Edit</a> -->
                    <a class="dropdown-item" href="<?= base_url('/home/hapus_peminjaman/'.$jo->id_peminjaman)?>"><i class="bx bx-trash me-1"></i> Delete</a>
                  </div>
                </div>
              </td>
            </tr>

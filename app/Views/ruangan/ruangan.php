...
<div class="col-lg-12">
  <div class="card custom-card"> <!-- Tambahkan kelas "custom-card" di sini -->
    <div class="card-body">
      ...
      <form action="<?= base_url('/home/keterangan_ruang/')?>" method="post">

        <a href="<?= base_url('/home/tambah_ruang/')?>"><button class="btn btn-success" type="button"><i class="fa fa-plus"></i>Tambah</button></a>
            ...
            foreach ($jofinson as $jo){
              ...
              <tr>
               <td class="text-center">
                <input type="checkbox" class="checkbox__input" value="<?= $jo->id_ruang ?>" name="ruang[]" id="ruang_<?= $jo->id_ruang ?>"/>
              </td>
              <td class="text-capitalize text-center"><?php echo $jo->nama_ruang?></td>
              <td class="text-capitalize text-center"><?php echo $jo->kode_ruang?></td>
              ...
              <td class="text-center">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?= base_url('/home/edit_ruang/'.$jo->id_ruang)?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                    <a class="dropdown-item" href="<?= base_url('/home/hapus_ruang/'.$jo->id_ruang)?>"><i class="bx bx-trash me-1"></i> Delete</a>
                  </div>
                </div>
              </td>
            </tr>

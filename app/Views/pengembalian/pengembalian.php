...
<div class="col-lg-12">
  <div class="card custom-card"> <!-- Tambahkan kelas "custom-card" di sini -->
    <div class="card-body">
      <a href="<?= base_url('/home/tambah_pengembalian/')?>"><button class="btn btn-success"><i class="fa fa-plus"></i>Tambah</button></a>
    </a>
    <br>
              ...
              <td class="text-center">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?= base_url('/home/hapus_pengembalian/'.$jo->id_pengembalian)?>"><i class="bx bx-trash me-1"></i> Delete</a>
                  </div>
                </div>
              </td>
            </tr>
